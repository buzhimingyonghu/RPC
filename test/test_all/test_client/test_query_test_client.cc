...
void test_client(const std::string& addr) {
  ...
  NEWMESSAGE(::querytestRequest, request);
  NEWMESSAGE(::querytestResponse, response);
  ...
  CALLRPRC(channel, TestService_Stub, query_test, controller, request, response, closure);
