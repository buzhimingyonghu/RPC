...
PROTOBUF_CONSTEXPR makeOrderRequest::makeOrderRequest(
    ::_pbi::ConstantInitialized) : _impl_{
                                       /*decltype(_impl_.goods_)*/ {&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}, /*decltype(_impl_.price_)*/ 0, /*decltype(_impl_._cached_size_)*/ {}} {}
...
PROTOBUF_CONSTEXPR makeOrderResponse::makeOrderResponse(
    ::_pbi::ConstantInitialized) : _impl_{
                                       /*decltype(_impl_.res_info_)*/ {&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}, /*decltype(_impl_.order_id_)*/ {&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}, /*decltype(_impl_.ret_code_)*/ 0, /*decltype(_impl_._cached_size_)*/ {}} {}
...
{
  makeOrderRequest *const _this = this;
  (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.goods_){}, decltype(_impl_.price_){}, /*decltype(_impl_._cached_size_)*/ {}};
    ...
    ::_pb::Arena *arena, bool is_message_owned)
{
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.goods_){}, decltype(_impl_.price_){0}, /*decltype(_impl_._cached_size_)*/ {}};
  _impl_.goods_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  _impl_.goods_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
makeOrderResponse::makeOrderResponse(const makeOrderResponse &from)
    : ::PROTOBUF_NAMESPACE_ID::Message()
{
  makeOrderResponse *const _this = this;
  (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.res_info_){}, decltype(_impl_.order_id_){}, decltype(_impl_.ret_code_){}, /*decltype(_impl_._cached_size_)*/ {}};
    ...
    ::_pb::Arena *arena, bool is_message_owned)
{
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.res_info_){}, decltype(_impl_.order_id_){}, decltype(_impl_.ret_code_){0}, /*decltype(_impl_._cached_size_)*/ {}};
  _impl_.res_info_.InitDefault();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  _impl_.res_info_.Set("", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
